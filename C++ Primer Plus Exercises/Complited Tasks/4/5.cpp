//4.5 The CandyBar structure contains three members.The first member holds the brand
...
int main()
{
	...
	cout << snack.brandName << " " << snack.weight << " ounces " << snack.numberOfCalories << " kcal";
